...
/* This file is auto-generated by the pycert_bearssl tool.  Do not change it
 * manually. Certificates are BearSSL br_x509_trust_anchor format.  Included
 * certs:
 *
 * Index:    0
 * Label:    GlobalSign
 ...
 * Network,O=VeriSign\, Inc.,C=US Domain(s): www.amazon.com
 */
...
static const br_x509_trust_anchor TAs[] = {
    ...
    {{(unsigned char *)TA_DN1, sizeof TA_DN1},
     ...
     {BR_KEYTYPE_RSA,
      {.rsa =
           {
               (unsigned char *)TA_RSA_N1,
               sizeof TA_RSA_N1,
               (unsigned char *)TA_RSA_E1,
               sizeof TA_RSA_E1,
           }}}},
};
